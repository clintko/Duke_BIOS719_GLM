...
# 7.1 (d) Evaluate appropriateness of the logit link
...
**Since the test is not significant, we do not reject the null that $\alpha = 1$**

# 7.1 (e) Provide predicted probability of leukemia (and 95% CI) for the highest dose group
